...
<!-- wp:paragraph {"className":"lbl"} --><p class="lbl">Para Kolaborator</p><!-- /wp:paragraph -->
<!-- wp:heading {"level":2,"className":"d d-xl","style":{"spacing":{"margin":{"top":"var:preset|spacing|jarak-2"}}}} --><h2 class="wp-block-heading d d-xl" style="margin-top:var(--wp--preset--spacing--jarak-2)">Spesial di hati kami</h2><!-- /wp:heading -->
</div>
<!-- /wp:group -->
